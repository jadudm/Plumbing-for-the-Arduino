...
If you're a publisher, and are interested in working with us to produce a print edition of this text, please drop an email to {\code matt at concurrency dot cc}. 

\section*{Bugs}
If you find errors in the text, please pass them on to {\code bookbugs at concurrency dot cc}.
