...
\begin{itemize}
	...
	\item We will call the stuff inside the \PROCedure its {\code body}. This is the code that makes up the actions of the \PROC we are writing. In our first program, there is only one line of code in the body of {\code main}.
